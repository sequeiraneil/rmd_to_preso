...
subtitle: "Presentations in Markdown"
author: "Neil Sequeira"
date: "2022/01/04"
output:
...
background-image: url('https://images.pexels.com/photos/269140/pexels-photo-269140.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')
...
Image credit: [Pexels](https://images.pexels.com)
...
.center[There's a **huge** need to improve the way I communicate]

--

.center[I'm keen to add another skill to PPT, and integrate them into my writing workflow]

--

.center[[RStudio IDE](https://www.rstudio.com/products/rstudio/) is a tool I'm familiar with and has some great features I can build this skill on.]
...
The documentation that [Yihui Xie](https://twitter.com/xieyihui) has on the [blogdown](https://bookdown.org/yihui/rmarkdown/xaringan.html) site is fantastic.

[Installation](https://bookdown.org/yihui/rmarkdown/xaringan-start.html) was a breeze. 
...
--
[John Gruber](https://twitter.com/gruber) and the late [Aaron Schwartz](https://www.rollingstone.com/culture/culture-news/the-brilliant-life-and-tragic-death-of-aaron-swartz-177191/) invented [Markdown](https://en.wikipedia.org/wiki/Markdown) in 2004. 

--
With just some basic commands, it is a markup language that is appealing to human readers in its source code form. The key design goal is readability.

--

Yihui Xie is a prolific developer on the RStudio platform, building incredibly useful software for statisticians and generally non-software types to build on. 

His `xaringan` pronounced sha-rin-gan package... 
...
.pull-left[![doggo](https://images-na.ssl-images-amazon.com/images/G/01/img15/pet-products/small-tiles/23695_pets_vertical_store_dogs_small_tile_8._CB312176604_.jpg)]

--
> `.pull-left[]` is the function to use to align the picture in a left column



--

> `[![doggo](image_url)]` is the function to use to embed the picture

--

.pull-right[<iframe width="560" height="315" src="https://youtu.be/FHy6NseH8yk" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>]

--
> `.pull-right[]` is the function to use to align the picture in a left column
